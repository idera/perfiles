...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
										...
										exclude-result-prefixes="gmd srv gco gmi">
	...
	<xsl:template match="gmi:MI_Metadata|*[@gco:isoType='gmi:MI_Metadata']">
		...
		<csw:Record>
			...
			<xsl:for-each select="$identification/gmd:extent/gmd:EX_Extent/gmd:geographicElement/gmd:EX_GeographicBoundingBox">
				<xsl:variable name="rsi"  select="/gmi:MI_Metadata/gmd:referenceSystemInfo/gmd:MD_ReferenceSystem/
					gmd:referenceSystemIdentifier/gmd:RS_Identifier|/gmi:MI_Metadata/gmd:referenceSystemInfo/
