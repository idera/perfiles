...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="analyze-inspire-themes-and-topiccategory">
        <xsl:param name="root"/>
        <xsl:variable name="lang" select="if (normalize-space($root//gmi:MI_Metadata/gmd:language/gco:CharacterString
            |$root//gmi:MI_Metadata/gmd:language/gmd:LanguageCode/@codeListValue)='') 
            then 'en' 
            else
            substring($root//gmi:MI_Metadata/gmd:language/gco:CharacterString
            |$root//gmi:MI_Metadata/gmd:language/gmd:LanguageCode/@codeListValue, 1, 2)
            "/>
    ...
    <xsl:template
        ...
        <xsl:copy>
            ...
            -->
            <xsl:variable name="lang" select="if (normalize-space(//gmi:MI_Metadata/gmd:language/gco:CharacterString
                |//gmi:MI_Metadata/gmd:language/gmd:LanguageCode/@codeListValue)='') 
                then 'en' 
                else
                substring(//gmi:MI_Metadata/gmd:language/gco:CharacterString
                |//gmi:MI_Metadata/gmd:language/gmd:LanguageCode/@codeListValue, 1, 2)
                "/>
