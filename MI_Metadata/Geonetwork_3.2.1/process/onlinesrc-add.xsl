...
-->
<xsl:stylesheet xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmi="http://www.isotc211.org/2005/gmi" xmlns:gml="http://www.opengis.net/gml" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
  ...
  of URL+Protocol+Name -->
	...
	<xsl:variable name="mainLang">
		<xsl:value-of select="(gmi:MI_Metadata|*[@gco:isoType='gmi:MI_Metadata'])/gmd:language/gmd:LanguageCode/@codeListValue"/>
	</xsl:variable>
										...
										<xsl:choose>
											<xsl:when test="contains($applicationProfile, '#')">
												<xsl:for-each select="tokenize($applicationProfile, $separator)">
													<xsl:variable name="nameLang" select="substring-before(., '#')"/>
													<xsl:variable name="nameValue" select="substring-after(., '#')"/>
									...
									<xsl:choose>
										<xsl:when test="contains($desc, '#')">
											<xsl:for-each select="tokenize($desc, $separator)">
												<xsl:variable name="descLang" select="substring-before(., '#')"/>
												<xsl:variable name="descValue" select="substring-after(., '#')"/>
