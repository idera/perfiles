  ...
  <xsl:template match="/">
    ...
    <xsl:template match="*" mode="metadata">
        ...
        <xsl:for-each select="gmd:identificationInfo//gmd:MD_DataIdentification|
            ...
            <xsl:variable name="email" select="/gmi:MI_Metadata/gmd:contact[1]/gmd:CI_ResponsibleParty[1]/gmd:contactInfo[1]/gmd:CI_Contact[1]/gmd:address[1]/gmd:CI_Address[1]/gmd:electronicMailAddress[1]/gco:CharacterString[1]"/>
