    ...
    <xsl:template name="document">
        ...
        <Document locale="{$isoLangId}">
            ...
            <xsl:variable name="title"
                select="/*[name(.)='gmi:MI_Metadata' or @gco:isoType='gmi:MI_Metadata']/gmd:identificationInfo//gmd:citation//gmd:title//gmd:LocalisedCharacterString[@locale=$poundLangId]"/>
