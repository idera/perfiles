...
<!-- ==================================================================== -->
    ...
    <xsl:template name="langId19139">
        <xsl:variable name="tmp">
            <xsl:choose>
                <xsl:when test="/*[name(.)='gmi:MI_Metadata' or @gco:isoType='gmi:MI_Metadata']/gmd:language/gco:CharacterString|
                                /*[name(.)='gmi:MI_Metadata' or @gco:isoType='gmi:MI_Metadata']/gmd:language/gmd:LanguageCode/@codeListValue">
                    <xsl:value-of select="/*[name(.)='gmi:MI_Metadata' or @gco:isoType='gmi:MI_Metadata']/gmd:language/gco:CharacterString|
                                /*[name(.)='gmi:MI_Metadata' or @gco:isoType='gmi:MI_Metadata']/gmd:language/gmd:LanguageCode/@codeListValue"/>
                </xsl:when>
    ...
    <xsl:template name="defaultTitle">
        ...
        <xsl:variable name="identification" select="/*[name(.)='gmi:MI_Metadata' or 
            ...
            @gco:isoType='gmi:MI_Metadata' or
