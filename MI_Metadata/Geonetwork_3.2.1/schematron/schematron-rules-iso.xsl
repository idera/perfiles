...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
	  ...
	  <!--RULE -->
<xsl:template match="//gmi:MI_Metadata|//*[@gco:isoType='gmi:MI_Metadata']" priority="1000"
                 mode="M23">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//gmi:MI_Metadata|//*[@gco:isoType='gmi:MI_Metadata']"/>
      <xsl:apply-templates select="*" mode="M23"/>
   </xsl:template>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
	  ...
	  <!--RULE -->
<xsl:template match="//gmi:MI_Metadata/gmd:hierarchyLevel|//*[@gco:isoType='gmi:MI_Metadata']/gmd:hierarchyLevel"
                 priority="1000"
                 mode="M29">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//gmi:MI_Metadata/gmd:hierarchyLevel|//*[@gco:isoType='gmi:MI_Metadata']/gmd:hierarchyLevel"/>
...
<xsl:if test="$hl = false()">
   ...
   <!--PATTERN $loc/strings/requiredElements-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
...
<xsl:if test="node() | @gco:nilReason">
   ...
   <!--PATTERN $loc/strings/requireCitation-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
