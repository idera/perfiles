...
<!--
  ...
  -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gmi="http://www.isotc211.org/2005/gmi" xmlns:gml="http://www.opengis.net/gml" version="1.0" exclude-result-prefixes="gmd srv">
	<!-- Parameters -->
	...
	<xsl:template match="/root/update/parent/gmi:MI_Metadata">
		<xsl:copy>
			...
			<gmd:identificationInfo>
				<xsl:for-each select="/root/child/gmi:MI_Metadata/gmd:identificationInfo/*">
					<xsl:copy>
						<xsl:copy-of select="@*"/>
						...
						<xsl:copy-of select="/root/update/parent/gmd:MI_Metadata/gmd:identificationInfo/*/gmd:characterSet"/>
	...
	<xsl:template name="process">
		...
		<xsl:param name="name"/>
		<xsl:param name="mode"/>
		<xsl:param name="subLevel" select="false()"/>
		<xsl:variable name="childElement">
			<xsl:choose>
				<xsl:when test="$subLevel=true()">
					<xsl:copy-of select="/root/child/gmi:MI_Metadata/gmd:identificationInfo/*/*[name(.)=name($name)]"/>
				</xsl:when>
				<xsl:otherwise>
